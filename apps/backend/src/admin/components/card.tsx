...
const CardRoot = ({ className, ...props }: CardRootProps) => {
  return (
    <Container className={clx("divide-y p-0", className)} {...props} />
  )
}
...
const CardHeader = ({ className, ...props }: CardHeaderProps) => {
  return (
    <div className={clx("px-6 py-4 flex items-center justify-between gap-2 flex-wrap", className)} {...props} />
  )
}
...
const CardContent = ({ className, ...props }: CardContentProps) => {
  return (
    <div className={clx("px-6 py-4 grid items-center gap-2", className)} {...props} />
  )
}
